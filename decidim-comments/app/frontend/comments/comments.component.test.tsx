...
describe("<Comments />", () => {
  ...
  it("renders loading-comments class and the respective loading text", () => {
    const wrapper = shallow(<Comments commentable={commentable} commentableType={commentableType} session={session} reorderComments={reorderComments} orderBy={orderBy} loading={true} />);
  ...
  it("renders a div of id comments", () => {
    const wrapper = shallow(<Comments commentable={commentable} commentableType={commentableType} session={session} reorderComments={reorderComments} orderBy={orderBy} />);
